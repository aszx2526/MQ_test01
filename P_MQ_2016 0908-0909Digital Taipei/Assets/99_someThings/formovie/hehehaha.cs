...
public class hehehaha : MonoBehaviour {
    public int myAniMod;
    ...
    [Header("大眼衝撞傷害")]
    public float mySkill1Hurtpoint;
    [Header("大眼衝撞CD時間")]
    ...
    [Header("翅膀迴旋傷害")]
    public float mySkill2Hurtpoint;
    [Header("翅膀迴旋CD時間")]
    ...
    [Header("20%大招傷害")]
    public float mySkill3Hurtpoint;
    [Header("20%大招CD時間")]
    ...
    public void myBigeyeModControll()
    {
        ...
        {//眼好翅壞-------------------------------------------------------------------2
            ...
            {
                print("eye good wing break");
                //myWingResumeTimer = 0;
                //myWingHitpoint.GetComponent<OnLookAtPoint>().myHP = 100;
    ...
    public void myFindAllMQAndAttack_Skill2()
    {
        ...
        {
            //myMQ[a].GetComponent<onMQVer3>().isBeHit = true;
         //   myMQ[a].GetComponent<onMQVer3>().myHP -= mySkill2Hurtpoint;
        }
    }
